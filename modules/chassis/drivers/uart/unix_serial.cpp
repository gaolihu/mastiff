...
# endif
    ...
    static inline void set_databits(termios *tio, bytesize_t databits) {
        tio->c_cflag &= ~CSIZE;
    ...
    SerialPortError SerialImpl::getSystemError(
    ...
    int SerialImpl::waitfordata(size_t data_count, uint32_t timeout,
    ...
    string SerialImpl::getPort() const {
        return port_;
    }

    void SerialImpl::setTimeout(Timeout &timeout) {
        timeout_ = timeout;
    }
    ...
    bool SerialImpl::setBaudrate(unsigned long baudrate) {
    ...
    bool SerialImpl::setStandardBaudRate(speed_t baudrate) {
#ifdef __linux__
    ...
    bool SerialImpl::setCustomBaudRate(unsigned long baudrate) {
        struct termios2 tio2;
        ...
        if (serial.custom_divisor * baudrate != (unsigned long)serial.baud_base) {
        }
    ...
    bool SerialImpl::setBytesize(bytesize_t bytesize) {
        termios tio;
    ...
    bytesize_t SerialImpl::getBytesize() const {
        return bytesize_;
    }

    bool SerialImpl::setParity(parity_t parity) {
        termios tio;
    ...
    parity_t SerialImpl::getParity() const {
        return parity_;
    }

    bool SerialImpl::setStopbits(stopbits_t stopbits) {
        termios tio;
    ...
    stopbits_t SerialImpl::getStopbits() const {
        return stopbits_;
    }

    bool SerialImpl::setFlowcontrol(flowcontrol_t flowcontrol) {
        termios tio;
    ...
    flowcontrol_t SerialImpl::getFlowcontrol() const {
        return flowcontrol_;
    }

    bool SerialImpl::setTermios(const termios *tio) {
    ...
    bool SerialImpl::getTermios(termios *tio) {
    ...
    bool SerialImpl::setBreak(bool level) {
        if (is_open_ == false) {
            return false;
        }
    ...
    bool SerialImpl::setRTS(bool level) {
        if (is_open_ == false) {
            return false;
        }
    ...
    bool SerialImpl::setDTR(bool level) {
        if (is_open_ == false) {
            return false;
        }
