 ...
 * @FilePath: /aventurier_framework/modules/chassis/drivers/soc/camera/angstrong_camera/as_camera.cc
...
void Camera::PublishAnImageRgb(const AS_Frame_s &img_data) {
    ...
    img_rgb_.set_encoding("bgr8");
    img_rgb_.set_is_bigendian(false);
    img_rgb_.set_step(img_data.width * 3);
