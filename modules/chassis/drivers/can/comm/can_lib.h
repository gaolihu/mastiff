...
#include "modules/chassis/drivers/can/comm/include/linux/can/error.h"
...
int parse_canframe(const char *cs, struct canfd_frame *cf);
/*
...
void sprint_long_canframe(char *buf , struct canfd_frame *cf, int view, int maxdlen, size_t* l);
/*
