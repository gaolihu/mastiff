...
genrule(
    ...
    cmd = "\
        echo \"int main()\n{\n\treturn 0;\n}\" > $(OUTS) && \
        cp $(location @//tools/valgrind:aarch64_build_valgrind.sh) 3rd_party/valgrind_3_19_0/ && \
        cd 3rd_party/valgrind_3_19_0/ && \
...
genrule(
    ...
    cmd = "\
        ...
        cd 3rd_party/valgrind_3_19_0/ && \
        realpath 3rd_party/valgrind_3_19_0/build_aarch64/> $(OUTS) \
    ",
)
...
genrule(
    ...
    cmd = "\
        echo \"int main()\n{\n\treturn 0;\n}\" > $(OUTS) && \
        cp $(location @//tools/valgrind:x64_build_valgrind.sh) 3rd_party/valgrind_3_19_0/ && \
        cd 3rd_party/valgrind_3_19_0/ && \
...
genrule(
    ...
    cmd = "\
        ...
        cd 3rd_party/valgrind_3_19_0/ && \
        realpath 3rd_party/valgrind_3_19_0/build_x64/ > $(OUTS) \
    ",
)
