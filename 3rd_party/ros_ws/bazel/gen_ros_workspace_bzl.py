...
def _format_str_list_for_build_file_d(lst, srv, indent=8):
    out = ""
    lst.sort()
    for l in lst:
        out += " " * indent + '"{}",\n'.format(l)
...
def parse_cmake_config_file(fp, ros_path):
    ...
    #print("")
    #print("___________________package_name___________________: ", package_name);
    ...
    blacklisted_libs = {"pthread", "debug", "optimized", "sqlite3"}
    sanitized_libs = [
    ...
    #print("msg_extras_path", msg_extras_path)
    if os.path.exists(msg_extras_path):
        ...
        service_files = _get_list_var_by_name(msg_extras_lines, package_name + "_SERVICE_FILES")

        #print("message_files: ", message_files, "LEN: ", len(message_files))
        #print("service_files: ", service_files, "LEN: ", len(service_files))

        if message_files == ['']:
            message_files = ""
            #print("change message_files", message_files);
        if service_files == ['']:
            service_files = ""
            #print("change service_files", service_files);
        ...
        #print("message_deps", message_deps, "LEN: ", len(message_deps))
    else:
        message_files = ""
        message_deps = ""
...
""".format(os.path.basename(__file__), fp)
    ...
    #generate message files workspace
    if message_files or service_files:
        build_file_contents += """
load("@//3rd_party/ros_ws/bazel:message_generation.bzl", "generate_messages")
"""
...
{deps}
        ...
        name=package_name,
        srcs=_format_str_list_for_build_file_d([
    ...
    #print("////////////////////ackage_name///////////////////: ", package_name);
    #print("")
