...
def cartographer_repositories():
    _maybe(
        ...
        sha256 = "2dc08e0869b41fcc8b90220364031413dd93a1c493c15fd993fdde28025f0185",
        strip_prefix = "rules_boost-0559057f13dd8084e6b68714bbe3a040066950f0",
        urls = [
            "https://github.com/nelhage/rules_boost/archive/0559057f13dd8084e6b68714bbe3a040066950f0.zip",
        ],
    )
    ...
    _maybe(
        ...
        build_file = "//external/slam/slam_3rd/pixman/pixman:pixman.BUILD",
    ...
    _maybe(
        ...
        build_file = "//external/slam/slam_3rd/cairo/cairo:cairo.BUILD",
    ...
    _maybe(
        ...
        build_file = "//external/slam/slam_3rd/fontconfig/fontconfig:fontconfig.BUILD",
